...
urlpatterns = [
    ...
    url(r'^funcionarios$', views.listar, name='listar'),
    url(r'^funcionarios/editar/(?P<pk>\d+)/$', views.editar, name='editar'),
    url(r'^funcionarios/(?P<pk>\d+)/$', views.visualizar, name='visualizar'),
    url(r'^funcionarios/detalhes/$', views.visualizar_usuario, name='visualizar_usuario'),
